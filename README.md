...
<details>
  <summary><b>👨‍💻 Currently working projects</b></summary><br><br>

  <!-- Secure Cloud Vault Bot -->
  <img src="https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white" alt="Python" width="65"> &nbsp;&nbsp; <strong>1. Secure Cloud Vault Bot using python :)</strong>
  <div align="center">
  </div>
  <p align="center">
      • A Telegram bot that allows users to securely store files with end-to-end encryption. <br><br>
      • Users can upload, access, and download files anytime using username, password, and email verification. <br><br>
      <b>💡 Security isn't a feature; it's a necessity!</b>
  </p>

  <br>

  <!-- Telegram mass reporter script -->
 <img src="https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white" alt="Python" width="65"> &nbsp;&nbsp; <strong>2. Telegram reporter script using python :)</strong>
  <div align="center">
  </div>
  <p align="center">
      • A Telegram tool to mass report illegal or harmful content. <br><br>
      • Helps in moderation and community protection because telegram not reply faster. <br><br>
...
<br>
<details>
  <summary><b>📚 Resources & Learning</b></summary><br>
  <div align="center">
    <p align="center">
      • <b>📕 Books:</b>  
      Clean Code by Robert C. Martin, Design Patterns by Gang of Four , You Don't Know JS by Kyle Simpsons  
      <br><br>
      • <b>🌐 Websites:</b>  
      FreeCodeCamp, W3Schools, MDN Web Docs, Roadmap.sh, CS50 by Harvard  
      <br><br>
      • <b>💻 Competitive Programming & DSA:</b>  
      LeetCode, HackerRank, CodeChef, CodeForces, GeeksforGeeks  
      <br><br>
      • <b>📺 English YouTube Channels:</b>  
      Traversy Media, The Net Ninja, Programming with Mosh, Fireship, Academind  
      <br><br>
      • <b>🎥 Hindi YouTube Channels:</b>  
      CodeWithHarry, Apna College, Love Babbar, Thapa Technical, Gate Smashers  
      <br><br>
      • <b>🎓 Online Courses:</b>  
      CS50 by Harvard, The Odin Project, Udemy, Coursera, edX  
    </p>
  </div>
</details>
...
<br>
<details>
  <summary><b>💖 Life & Philosophy</b></summary><br>
  <div align="center">
    <p align="center">
      • The best way to predict the future is to create it.<br>
      <br>
      • Coding is not just coding; it helps you avoid distractions and escape life's troubles.<br>
      <br>
      • Think like a poet, write like an artist, and solve like a mathematician.
    </p>
  </div>
</details>
<br>
<details>
  <summary><b>🚀 For Beginners</b></summary><br>
  <div align="center">
    <p align="center">
      • <b>🌱 Start Small:</b> Begin with simple projects and gradually build complexity<br>
      <br>
      • <b>📘 Learn by Doing:</b> Practice coding daily, even if it's just for 30 minutes<br>
      <br>
      • <b>🤝 Join Communities:</b> Connect with fellow developers on forums like Stack Overflow<br>
      <br>
      • <b>🔍 Read Documentation:</b> Understanding how to read docs is a crucial skill<br>
      <br>
      • <b>🛠️ Use Version Control:</b> Learn Git early, it will save you countless headaches<br>
      <br>
      • <b>⏱️ Be Patient:</b> Programming takes time to master, don't be discouraged by errors
    </p>
  </div>
</details>
